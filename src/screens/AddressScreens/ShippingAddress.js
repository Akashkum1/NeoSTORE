    ...
    <View style={styles.addressView}>
      ...
      {addressDataResponse === null?
        ...
        <View style={styles.container}>
          {props.route.params['values']?<Text style={styles.suggestion}>*Please Click on atleast one address to proceed to buy</Text>:null}
          ...
          <TouchableOpacity onPress={() =>{props.navigation.navigate('AddAddress')}} style={styles.addAddressButton}>
